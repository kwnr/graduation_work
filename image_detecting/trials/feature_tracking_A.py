...
target=cv2.imread('/Users/hyeokbeom/Desktop/graduation_work/image_detecting/template_A.png',cv2.IMREAD_GRAYSCALE)
...
while cap.isOpened():
    ...
    res=cv2.drawMatches(img,img_key,target,target_key,good_matches,None,flags=cv2.DRAW_MATCHES_FLAGS_NOT_DRAW_SINGLE_POINTS)
